...
QT_MOC_LITERAL(1, 7, 12), // "phaseChanged"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 16), // "frequencyChanged"
QT_MOC_LITERAL(4, 38, 16), // "amplitudeChanged"
QT_MOC_LITERAL(5, 55, 14), // "onValueChanged"
QT_MOC_LITERAL(6, 70, 5) // "value"

    },
    "Slider\0phaseChanged\0\0frequencyChanged\0"
    "amplitudeChanged\0onValueChanged\0value"
};
...
void Slider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->phaseChanged((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->frequencyChanged((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 2: _t->amplitudeChanged((*reinterpret_cast< double(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Slider::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Slider::phaseChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Slider::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Slider::frequencyChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Slider::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Slider::amplitudeChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Slider::phaseChanged(double _t1)
{
...
// SIGNAL 1
void Slider::frequencyChanged(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void Slider::amplitudeChanged(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
